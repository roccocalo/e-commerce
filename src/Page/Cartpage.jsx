...
function Cartpage() {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className={`flex  justify-center items-center gap-4 pb-3 text-xl ${cartItems.length == 0 ? 'hidden' : '' } `}>
            ...
            <div className={`flex  justify-center items-center gap-4 pt-96 text-xl ${cartItems.length == 0 ? '' : 'hidden' } `}>
