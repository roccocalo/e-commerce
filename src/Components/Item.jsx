...
function Item({ item }) {
    ...
    return (
        <div className={`p-5 border-2 border-[#374f54] rounded flex flex-col items-center gap-3 shadow-xl bg-white dark:bg-[#414141] md:h-[600px] ${isExpanded ? 'md:h-[700px]' : ''}`}>
            ...
            <button className="p-2 px-6 bg-[#374f54] text-white dark:text-[#121212] rounded-md" onClick={() => addToCart(item)}>Add To Cart</button>
