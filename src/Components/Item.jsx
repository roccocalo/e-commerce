...
function Item({ item }) {
    ...
    return (
        <div className={`p-5 border-2 border-[#374f54] rounded flex flex-col items-center gap-3 bg-white md:h-[600px] ${isExpanded ? 'md:h-[700px]' : ''}`}>
            ...
            <button className="p-2 px-6 bg-[#374f54] text-white rounded-md">Add To Cart</button>
