...
function ItemCart({ item }) {
    ...
    return (
        <>
            ...
            <div className="hidden md:flex p-5 border-2 border-[#374f54] justify-evenly rounded shadow-xl bg-white w-[1100px]">
                <div>
                    <img className=" w-auto h-32 object-cover object-center" src={item.image} alt="" />
                </div>
                <div className="flex flex-col gap-3">
                    <p className="font-bold text-2xl text-center max-w-[500px]   ">{item.title}</p>
