        ...
        <div className="p-2 bg-[#374f54] ">
            <div className="flex flex-col gap-4 md:pt-2">
                <div className="flex flex-col md:flex-row md:gap-12 gap-2 justify-center items-center text-white">
                    ...
                    <span className=" border dark:border-[#121212]" >
                    ...
                    <p className="mb-1 md:mb-0 dark:text-black">Unlock 10% off your initial order upon registration!</p>
                </div>
                <div className="flex md:flex-row flex-col justify-center md:gap-20 gap-4 ">
                    <ul className="flex justify-center md:gap-8 gap-4  text-[#dfc9b3]">
                        ...
                        <li className="underline md:text-white dark:text-black"><a href="">Blog</a></li>
                        <li className="underline md:text-white dark:text-black"><a href="">Terms of Service</a></li>
                        <li className="underline md:text-white dark:text-black"><a href="">FAQ</a></li>
                    </ul>
                    <ul className="flex justify-center gap-8  text-white">
                        <li className="underline dark:text-black"><a href="https://www.freepik.com/free-photo/fast-fashion-vs-slow-sustainable-fashion_19533979.htm#page=2&position=16&from_view=search&track=ais&uuid=e5968f40-afb3-4b7c-8aed-173504117319">Image by Freepik</a></li>
                        <li className="underline dark:text-black"><a href="https://www.flaticon.com/free-icons/internet" >Logo by Flaticon</a></li>
                    </ul>
                </div>
